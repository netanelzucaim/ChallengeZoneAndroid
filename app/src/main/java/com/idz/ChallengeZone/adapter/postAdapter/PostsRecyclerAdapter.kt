...
class PostsRecyclerAdapter(private var posts: List<Post>?, private val lifecycleOwner : LifecycleOwner, private val sourceScreen: String): RecyclerView.Adapter<PostViewHolder>() {
    ...
    fun set(posts: List<Post>?) {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostViewHolder {
            ...
            return PostViewHolder(binding, listener, sourceScreen)
        }
